    ...
    class HexToDec
    {
        ...
        static int DeHex(string hexnumber)
        {
            ...
            switch (hexnumber)
            {
                ...
                case "A": decimalnr = 10; break;
                case "B": decimalnr = 11; break;
                case "C": decimalnr = 12; break;
                case "D": decimalnr = 13; break;
                case "E": decimalnr = 14; break;
                case "F": decimalnr = 15; break;
